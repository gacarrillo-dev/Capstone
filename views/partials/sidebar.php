...
<!--        <div class="bg-gradient-to-r from-red-700 to-red-900 h-px mt-2"></div>-->
        ...
        <?php foreach ($users_lists as $user_list) : ?>
            ...
            ?>
            <a class="block text-gray-200 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-zinc-900/85 hover:text-white flex justify-between items-center" href="/lists?id<?= htmlspecialchars($user_list['list_id']) ?>">
