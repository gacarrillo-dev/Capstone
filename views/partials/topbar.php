    ...
    <div class="space-x-5 flex flex-row">
        ...
        <div class="relative max-w-md w-full items-center">
            <form id="searchForm" action="search.php" method="get">
                ...
                <input id="searchInput"
                    class="w-full h-10 pl-10 pr-4 py-1 text-zinc-950 text-base placeholder-gray-500 border rounded-full focus:ring focus:ring-red-800 focus:ring-opacity-80"
                    type="search" name="query" placeholder="Search tasks...">
            </form>
        </div>
        ...
        <div class="flex item-center">
            ...
            <div id="dropdown-menu"
                class="origin-top-right absolute right-0 mt-8 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 hidden">
                <div class="py-2 p-2" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-button">
                    <?php if($_SESSION['user_level'] == 1): ?>
                    <a class="flex items-center block rounded-md px-4 py-2 text-md text-black hover:bg-gray-200 active:bg-blue-100 cursor-pointer"
                        role="menuitem" href="adminHomePage.php">
                        <i class="fa-solid fa-desktop mr-3"></i>Admin Mode
                    </a>
                    <?php endif; ?>
                    <a class="flex items-center block rounded-md px-4 py-2 text-md text-black hover:bg-gray-200 active:bg-blue-100 cursor-pointer"
                        role="menuitem" href="profile.php">
                        <i class="fa-regular fa-id-card mr-3"></i> Profile Settings
                    </a>
                    <a class="flex items-center block rounded-md px-4 py-2 text-md text-black hover:bg-gray-200 active:bg-blue-100 cursor-pointer"
                        role="menuitem" href="logout.php">
