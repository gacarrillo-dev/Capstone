                    ...
                    <?php foreach ($upcomingTasks as $upcomingTask) : ?>
                        ...
                        <li class="p-4 rounded-lg bg-zinc-950 my-4 flex flex-row justify-between">
                            ...
                            <div class="flex flex-col">
                                ...
                                <!-- Due Date -->
                                <div>
                                    <?php $due_date = new DateTime($upcomingTask['due_date']);
                                    $formatted_due_date = $due_date->format("M j, Y");
                                    ?>
                                    <!-- Hidden due date -->
                                    <input type="hidden" id="taskDueDate" name="taskDueDate" value="<?= htmlspecialchars($upcomingTask['due_date']) ?>">
                            ...
                            <div class="flex items-center ml-10">
                                <p class="text-orange-400/85 font-medium mr-6"><?= htmlspecialchars($upcomingTask['list_name']) ?></p>
