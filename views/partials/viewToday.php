                    ...
                    <?php foreach ($tasks as $task) : ?>
                        ...
                        <li class="p-4 rounded-lg bg-zinc-950 my-4 flex flex-row justify-between">
                            ...
                            <div class="flex flex-col">
                                ...
                                <!-- Title -->
                                <h3 class="text-lg font-semibold text-stone-200 hover:underline hover:cursor-pointer hover:text-red-800" id="taskTitle"><?= htmlspecialchars($task['title']) ?></h3>
                            ...
                            <div class="flex items-center ml-10">
                                <p class="text-orange-400/85 font-medium mr-6"><?= htmlspecialchars($task['list_name']) ?></p>
