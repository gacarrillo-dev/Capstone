    ...
    <div class="bg-zinc-900 p-8 rounded-lg max-w-md">
        ...
        <form id="taskForm" class="space-y-4">
            <div>
                ...
                <select id="lists" class="bg-zinc-950/80 border border-gray-300 text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="flex items-center">
                <input type="checkbox" id="isFavorite" name="isFavorite" class="mr-2">
